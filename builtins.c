 ...
 * Return: pointer to a NULL
 */
const builtin_t *get_builtins(void)
{
	static builtin_t builtins[] = {
		{"alias", _alias, ALIAS_HELP, ALIAS_DESC},
		{"cd", _cd, CD_HELP, CD_DESC},
		{"enc", _env, ENV_HELP, ENV_DESC},
		{"exec", _exec, EXEC_HELP, EXEC_DESC},
		{"exit", _exit, EXIT_HELP, EXIT_DESC},
		{"help", _help, HELP_HELP, HELP_DESC},
		{"setenv", _setenv, SETENV_HELP, SETENV_DESC},
		{"unsetenv", _unsetenv, UNSETENV_HELP, UNSETENV_DESC},
		{0}
	};
	return (builtins);
